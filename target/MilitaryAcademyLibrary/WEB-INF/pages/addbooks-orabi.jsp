                ...
                <div class="x_content">
                  ...
                  <form:form action="addbook" method="post" modelAttribute="book" enctype="multipart/form-data" class="form-horizontal form-label-left" >
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text"  name="bookName"  required="required" class="form-control col-md-7 col-xs-12">
                      </div>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text"  name="writerName" required="required" placeholder="" class="form-control col-md-7 col-xs-12">
                      </div>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" name="publisherName"  class="optional form-control col-md-7 col-xs-12">
                      </div>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" name="printerNumber"  class="form-control col-md-7 col-xs-12" required="required">
                      </div>
                      <span class="required"></span><label for="password" class="control-label col-md-3">رقم الطبعه</label>
                    </div>
                    <div class="item form-group">
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input  type="date" name="buyingDate"  class="form-control col-md-7 col-xs-12" required="required">
                      </div>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" required="required" name="publisherDate" class="form-control col-md-7 col-xs-12">
                      </div>
                     ...
                     <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" required="required" name="department" class="form-control col-md-7 col-xs-12">
                      </div>
                     ...
                     <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="file" required="required" name="bookFile" class="form-control col-md-7 col-xs-12">
                      </div>
