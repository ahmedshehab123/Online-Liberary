						...
						<form   action="add-product" method="post" 
							...
							<div class="item form-group">
								...
								<label class="control-label col-md-3 col-sm-3 col-xs-12"
									for="name">صوره المنتج <span class="required"></span>
								</label>
							</div>
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="text" class="btn btn-round btn-default"
										name="productName"  required="required" />
								</div>
								<label class="control-label col-md-3 col-sm-3 col-xs-12"
									for="name">اسم المنتج <span class="required"></span>
								</label>
							</div>
							<div class="item form-group">
								...
								<label class="control-label col-md-3 col-sm-3 col-xs-12"
									for="name">السعر <span class="required"></span>
								</label>
							</div>
							<div class="item form-group">
								...
								<label class="control-label col-md-3 col-sm-3 col-xs-12"
									for="name">المكان <span class="required"></span>
								</label>
							</div>
