			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					...
					<div class="x_content" id="tabs-1">
						...
						<form action="upload-supervision-plan" method="post"
							...
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="file" class="btn btn-round btn-default"
										name="filePath" value="Upload CSV file" required="required" />
								</div>
								<label class="control-label col-md-3 col-sm-3 col-xs-12"
									for="name">ملف خطة الاعمال في صيغة pdf <span class="required"></span>
								</label>
							</div>
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="date" class="btn btn-round btn-default"
										name="planDate"  required="required" />
								</div>
								<label class="control-label col-md-3 col-sm-3 col-xs-12"
									for="name">تاريخ الخطه <span class="required"></span>
								</label>
							</div>
