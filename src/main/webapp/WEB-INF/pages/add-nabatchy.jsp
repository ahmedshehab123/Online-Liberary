...
${added }
 ...
 <form action="add-nabatchy" method="post" enctype="multipart/form-data" class="form-horizontal form-label-left" >
							...
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="file" class="btn btn-round btn-default"
										name="picturePath" value="Upload CSV file" required="required" />
								</div>
								<label class="control-label col-md-3 col-sm-3 col-xs-12"
									for="name">صوره النبطشيات <span class="required"></span>
								</label>
							</div>
