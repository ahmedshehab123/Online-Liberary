...
<%@ include file="libheader.jsp" %>
		...
		<div class="online-banner-area">
		    <div class="container">
		        <div class="banner-title text-center">
		            <h2><span>قسم</span> ${department} </h2>
		        </div>
	...
	<div class="layer-4">
		...
		<div class="featured-product-area section-padding">
            <h2 class="section-title">محتويات القسم</h2><h1 style="position: relative; left:900px; top:-50px;" >${department}</h1>
            <h1 style="position: relative; left:200px; top:-100px;" >   عدد الكتب  ${size}  </h1>
            <div class="container">
                    ...
                    <div class="product-list tab-content">
                        <div role="tabpanel" class="tab-pane fade in active" id="arrival">
                            <div class="featured-product-list indicator-style">
                                ...
                                <c:forEach var="book" items="${estalam }">
                                    ...
                                    <div class="col-md-3">
                                        <div class="single-banner">
                                            ...
                                            <div class="banner-bottom text-center">
                                                <a  href="preview-orabi-book?generatedName=${book.generatedName }" target="_blank" id="${book.bookID}"><h3>${book.bookName }</h3></a>
		                        </div>
