...
<title>Monitoring | Library</title>
		...
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					...
					<tr>  
									 <td><a style="color: blue;" href="preview?generatedName=${book.generatedName }" target="_blank">book reader</a></td>
					...
					buttons : [ {
						...
						//autoPrint: false,
						  customize: function ( win ) {
			                    $(win.document.body)
			                        .css( 'dir', 'rtl').css('text-align','right');
