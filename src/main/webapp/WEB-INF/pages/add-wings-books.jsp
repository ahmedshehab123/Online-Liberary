...
<div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <form:form action="add-wing-book" method="post" modelAttribute="book" enctype="multipart/form-data" class="form-horizontal form-label-left" >
                     ...
                     <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                       <select class="form-control col-md-7 col-xs-12" id="department" name="department" onchange="findBooks()">
                        ...
                        <c:forEach var="gen" items="${departments }">
